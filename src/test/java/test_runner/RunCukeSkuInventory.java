...
@CucumberOptions(features = "classpath:SKU", plugin = { "pretty", "html:target/cucumber-html-report",
		"json:target/cucumber.json" }, glue = { "step_defination" }, tags = { "@Regression" })
public class RunCukeSkuInventory {
	...
	@BeforeClass
	public void onStart() {
		GlobalUtil.reportfolder = "Inventorycreation";
	...
	public Object[][] inventorycreation() {
		// super.init();

		return utilities.DataUtil.getTestData(xls, "Inventories creation", "SKUData");
	}

	@Test(dataProvider = "inventorycreation")
	private void ftuuser(Hashtable<String, String> data) throws InterruptedException {
		for (Object[] objects : features) {

			if (objects[0].toString().equals("Inventories creation")) {
