...
"json:target/cucumber.json" },glue= {"step_defination"}, tags = {"@PrerequisiteFTU" })
public class RunCukesPrerequisiteFTU {
	...
	@BeforeClass
	public void onStart() {
		GlobalUtil.reportfolder="Prerequisite-FTU";
	...
	public Object[][] Prerequisite() {
		...
		return utilities.DataUtil.getTestData(xls, "Prerequisite-FTU","PrerequisiteData");
	}
	
	@Test(dataProvider = "Prerequisite")
	private void ftuuser(Hashtable<String, String> data) throws InterruptedException {
		for (Object[] objects : features) {

			if (objects[0].toString().equals("Prerequisite-FTU")) {
