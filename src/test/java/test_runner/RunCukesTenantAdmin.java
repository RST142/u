...
@CucumberOptions(features = "classpath:TenantAdmin", plugin = { "pretty",
		"html:target/cucumber-html-report", "json:target/cucumber.json" },glue= {"step_defination"}, tags = { "@TenantLoginCreateNewAD" })
public class RunCukesTenantAdmin {
	...
	@BeforeClass
	public void onStart() {
		GlobalUtil.reportfolder = "Tenant-Admin";
	...
	public Object[][] TenanLoginCreateNewAD() {
		// super.init();

		return utilities.DataUtil.getTestData(xls, "Tenant-Login-Create-New-AD", "TenantData");
	}


	@Test(dataProvider = "TenanLoginCreateNewAD")
	private void TenantLogin(Hashtable<String, String> data) throws InterruptedException {

		for (Object[] objects : features) {

			if (objects[0].toString().equals("Tenant-Login-Create-New-AD")) {
	...
	public void onFinish() {
		...
		System.out.println( " suite finished" + " at " + new Date());
