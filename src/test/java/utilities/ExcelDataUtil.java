...
public class ExcelDataUtil {
	...
	private static String testDatafilePath = "src"+fileSeparator+"test"+fileSeparator+"resources"+fileSeparator+"testData"+fileSeparator+"TestData.xlsx";
	...
	private static String automationcontrolexcelpath =  "src"+fileSeparator+"test"+fileSeparator+"resources"+fileSeparator+"ExcelFiles"+fileSeparator+"AutomationControlSheet.xlsx";
	...
	public static CommonSettings getCommonSettings() {
		...
		try(FileInputStream fis =new FileInputStream(automationcontrolexcelpath); 
			...
			commonSettings.setProjectName(sheet.getRow(1).getCell(1).getStringCellValue());
